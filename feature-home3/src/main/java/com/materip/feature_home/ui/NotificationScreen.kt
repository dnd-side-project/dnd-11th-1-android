...
//                profileThumbnail = uiState.profileThumbnail
//            )
        }
...
private fun NotificationList(
    ...
    Column(
        ...
        notifications.forEach { notification ->
            val isSentByUser = profileThumbnail.userId == notification.userId
            ...
            Row(
                ...
                Box(
                    ...
                    if (profileThumbnail.profileImageUrl.isEmpty()) {
                        Image(
                        ...
                        SubcomposeAsyncImage(
                            model = profileThumbnail.profileImageUrl,
                ...
                if (isSentByUser) {
                    Text(text = notification.getFormattedMessage())
                }
            }
        }
    }
