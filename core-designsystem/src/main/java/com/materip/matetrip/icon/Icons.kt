...
object Icons {
    val notification_icon = R.drawable.notification_24px
    val man_icon = R.drawable.man
    val add_icon = R.drawable.add_24px
    val arrow_back_icon = R.drawable.arrow_back_24px
    val close_icon = R.drawable.close_24px
    val date_icon = R.drawable.date_24px
    val enter_16_icon = R.drawable.enter_16px
    val enter_24_icon = R.drawable.enter_24px
    val fold_icon = R.drawable.fold_24px
    val gender_icon = R.drawable.gender_24px
    val home_icon = R.drawable.home_24px
    val my_page_icon = R.drawable.mypage_24px
    val navigate_next_icon = R.drawable.navigate_next_24px
    val open_icon = R.drawable.open_24px
    val party_icon = R.drawable.party_24px
